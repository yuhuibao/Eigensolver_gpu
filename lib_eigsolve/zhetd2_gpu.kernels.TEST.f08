...
function test_launch_zhetd2_gpu()
  ...
  ! TODO run the test
  CALL launch_zhetd2_gpu(0,c_null_ptr,grid,block,sharedMem,stream,lda,a,a_n1,a_n2,tau,tau_n1,d,d_n1,e,e_n1,n) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_zhetd2_gpu_cpu(0,c_null_ptr,grid,block,sharedMem,stream,lda,a,a_n1,a_n2,tau,tau_n1,d,d_n1,e,e_n1,n)
