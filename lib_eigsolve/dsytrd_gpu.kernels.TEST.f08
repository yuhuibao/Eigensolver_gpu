...
function test_launch_krnl_2b8e8f_0_auto()
  ...
  ! TODO run the test
  CALL launch_krnl_2b8e8f_0_auto(0,c_null_ptr,sharedMem,stream,d,a,n) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_krnl_2b8e8f_0_cpu(0,c_null_ptr,sharedMem,stream,d,a,n)
...
function test_launch_krnl_37a79c_1_auto()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_krnl_37a79c_1_auto(0,c_null_ptr,sharedMem,stream,n,iw,w) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_krnl_37a79c_1_cpu(0,c_null_ptr,sharedMem,stream,n,iw,w)
...
function test_launch_dsyr2_mv_kernel()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_dsyr2_mv_kernel(0,c_null_ptr,grid,block,sharedMem,stream,n,m,ldv,ldw,ldw2) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_dsyr2_mv_kernel_cpu(0,c_null_ptr,grid,block,sharedMem,stream,n,m,ldv,ldw,ldw2)
...
function test_launch_dlarfg_kernel()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_dlarfg_kernel(0,c_null_ptr,grid,block,sharedMem,stream,n,tau,e,x) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_dlarfg_kernel_cpu(0,c_null_ptr,grid,block,sharedMem,stream,n,tau,e,x)
...
function test_launch_dsyr2_mv_dlarfg_kernel()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_dsyr2_mv_dlarfg_kernel(0,c_null_ptr,grid,block,sharedMem,stream,n,m,ldv,ldw,ldw2,tau,e,finished) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_dsyr2_mv_dlarfg_kernel_cpu(0,c_null_ptr,grid,block,sharedMem,stream,n,m,ldv,ldw,ldw2,tau,e,finished)
...
function test_launch_stacked_dgemv_t()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_stacked_dgemv_t(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,x,z1,z2) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_stacked_dgemv_t_cpu(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,x,z1,z2)
...
function test_launch_stacked_dgemv_n()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_stacked_dgemv_n(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,z1,z2,y) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_stacked_dgemv_n_cpu(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,z1,z2,y)
...
function test_launch_finish_w_col_kernel()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_finish_w_col_kernel(0,c_null_ptr,grid,block,sharedMem,stream,n,tau,x,y) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_finish_w_col_kernel_cpu(0,c_null_ptr,grid,block,sharedMem,stream,n,tau,x,y)
...
function test_launch_stacked_dgemv_n_finish_w()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_stacked_dgemv_n_finish_w(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,z1,z2,y,tau,x,finished) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_stacked_dgemv_n_finish_w_cpu(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,z1,z2,y,tau,x,finished)
