...
function test_launch_krnl_2b8e8f_0_auto()
  ...
  ! TODO run the test
  CALL launch_krnl_2b8e8f_0_auto(0,c_null_ptr,sharedMem,stream,a,d,n) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_krnl_2b8e8f_0_cpu(0,c_null_ptr,sharedMem,stream,a,d,n)
...
function test_launch_krnl_9c27cb_1_auto()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_krnl_9c27cb_1_auto(0,c_null_ptr,sharedMem,stream,iw,n,w) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_krnl_9c27cb_1_cpu(0,c_null_ptr,sharedMem,stream,iw,n,w)
...
function test_launch_zher2_mv_kernel()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_zher2_mv_kernel(0,c_null_ptr,grid,block,sharedMem,stream,n,m,ldv,ldw,ldw2) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_zher2_mv_kernel_cpu(0,c_null_ptr,grid,block,sharedMem,stream,n,m,ldv,ldw,ldw2)
...
function test_launch_zlarfg_kernel()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_zlarfg_kernel(0,c_null_ptr,grid,block,sharedMem,stream,n,tau,e,x) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_zlarfg_kernel_cpu(0,c_null_ptr,grid,block,sharedMem,stream,n,tau,e,x)
...
function test_launch_zher2_mv_zlarfg_kernel()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_zher2_mv_zlarfg_kernel(0,c_null_ptr,grid,block,sharedMem,stream,n,m,ldv,ldw,ldw2,tau,e,finished) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_zher2_mv_zlarfg_kernel_cpu(0,c_null_ptr,grid,block,sharedMem,stream,n,m,ldv,ldw,ldw2,tau,e,finished)
...
function test_launch_stacked_zgemv_c()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_stacked_zgemv_c(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,x) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_stacked_zgemv_c_cpu(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,x)
...
function test_launch_stacked_zgemv_n()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_stacked_zgemv_n(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,z1,z2) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_stacked_zgemv_n_cpu(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,z1,z2)
...
function test_launch_stacked_zgemv_n_finish_w()
  ...
  ! ... might be more (or less) than two memcopies 
  ! TODO run the test
  CALL launch_stacked_zgemv_n_finish_w(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,z1,z2,tau,x,y2,finished) ! Modify sharedMem if other than default 0
  CALL hipCheck(hipDeviceSynchronize())
  CALL launch_stacked_zgemv_n_finish_w_cpu(0,c_null_ptr,grid,block,sharedMem,stream,m,n,ldv,ldw,v,w,z1,z2,tau,x,y2,finished)
