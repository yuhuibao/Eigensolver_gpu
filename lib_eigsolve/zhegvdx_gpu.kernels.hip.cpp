...
__global__ void krnl_959801_0(TODO declaration not found a, int n, TODO declaration not found z) {
...
extern "C" void launch_krnl_959801_0(dim3 *grid,
  ...
  hipLaunchKernelGGL((krnl_959801_0), *grid, *block, sharedMem, stream, a, n, z);
}
extern "C" void
launch_krnl_959801_0_auto(const int sharedMem, hipStream_t stream, TODO declaration not found a, int n, TODO declaration not found z) {
